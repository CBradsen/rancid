...
function DetailedView({title, posterImg, backdropImg, releaseDate, overview, averageRating, genres, budget, revenue, runtime, tagline}) {

    <div className="single-movie">
      <button>Back to main on click</button>
